...
#Question 2 
Journaliste_nombre = Journaliste.select { |items| items =~ /[0123456789]/ }
puts "Combien d'handle contiennent un numéro ?"
puts Journaliste_nombre.count 


#Question 3 
Journaliste_Aude = Journaliste.select {|x| x.downcase.include?("aude")} 
puts "Combien d'handle contiennent les 4 lettres du prénom AUde"
puts Journaliste_Aude.count

#Question 4 
Journaliste_début_MAJ = Journaliste.select {|item| item[1..1] =~ /[A-Z^]/}
puts "Combien contiennent une majuscule en début de nom ? "
puts Journaliste_début_MAJ 


#Question 5 
Journaliste_Majuscule = Journaliste.select { |y| y =~ /[A-Z]/}
puts "Combien contiennent une majuscule ?"
puts Journaliste_Majuscule.count


#Question 6
Journaliste_Dash = Journaliste.select	{ |z| z =~ /[_]/}
puts "Combien de _ dans tous les pseudos confondus ?"
puts Journaliste_Dash.count

#Question 7
alphabet = Journaliste.map 
alphabet2 = alphabet.sort 
